            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <div className="flex items-start gap-3">
                  <div className="bg-[#FF6B00] text-white rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 mt-0.5">
                    1
                  </div>
                  <div>
                    <p className="font-medium">Contact Us</p>
                    <p className="text-sm text-gray-600">Tell us your ad goals and business type.</p>
                  </div>
                </div>
                
                <div className="flex items-start gap-3">
                  <div className="bg-[#0066CC] text-white rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 mt-0.5">
                    2
                  </div>
                  <div>
                    <p className="font-medium">We Assign Account Access</p>
                    <p className="text-sm text-gray-600">Use our verified ad accounts for Meta or Google.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium">You Launch & Grow</p>
                    <p className="text-sm text-gray-600">Focus on results while we handle the backend.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-[#0066CC] to-[#0055AA] rounded-xl p-6 text-white">
                ...
                <a href="#contact">
                  <Button className="bg-[#FF6B00] hover:bg-[#FF8533] py-5 px-6 text-white font-medium rounded-lg">
                    Get Access Now
                    <ArrowRight className="ml-2 h-5 w-5" />
                  </Button>
                </a>
                <div className="flex items-center justify-center mt-4 text-sm gap-4">
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 mt-8">
                  <h3 className="text-lg font-semibold mb-4 text-center">Supported Ad Platforms</h3>
