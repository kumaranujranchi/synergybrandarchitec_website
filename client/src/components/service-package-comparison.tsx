  ...
  const monthlyPackages: ServicePackage[] = [
    {
      ...
      features: [
        ...
        { name: "Blog Articles", included: true, info: "1 article/month" },
    ...
    },
    {
      ...
      features: [
        ...
        { name: "Social Media Posts", included: true, info: "20 posts/month" },
        { name: "Blog Articles", included: true, info: "2 articles/month" },
        { name: "Graphic Design", included: true, info: "10 designs/month" },
    ...
    },
    {
      ...
      features: [
        ...
        { name: "Target Audience Identification", included: true },
        { name: "Campaign Calendar", included: true },
        { name: "Social Media Posts", included: true, info: "30 posts/month" },
        { name: "Blog Articles", included: true, info: "4 articles/month" },
        { name: "Graphic Design", included: true, info: "Unlimited" },
