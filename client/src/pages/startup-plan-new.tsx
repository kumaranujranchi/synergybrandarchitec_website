            ...
            <div className="relative">
              <div className="bg-white rounded-xl shadow-xl p-8 border border-gray-100 relative z-10">
                ...
                <p className="text-center text-sm text-gray-500 mt-3">
                  Available for both Indian & International clients
                </p>
              </div>
                ...
                <div className="bg-white shadow-xl rounded-xl overflow-hidden border border-gray-200 sticky top-24">
                  ...
                  <div className="p-6">
                    ...
                    <div className="border-t border-gray-100 pt-4 mb-6">
                      ...
                      <p className="text-sm text-gray-500">Multiple payment options available</p>
                    </div>
      ...
      <section id="payment-options" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-[#FF6B00] to-[#0066CC] mb-6"></div>
            <p className="text-lg text-gray-700 max-w-3xl">
              Choose a payment method below to begin your digital journey. Pay just ₹2,000 advance 
              to secure your spot in our development queue.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
                <div className="bg-gradient-to-r from-[#2d84fb] to-[#1a73e8] p-6 text-white">
                  <h3 className="text-xl font-semibold">For Indian Customers</h3>
              ...
              {/* PayPal Section */}
              <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
                <div className="bg-gradient-to-r from-[#0070BA] to-[#003087] p-6 text-white">
                  <h3 className="text-xl font-semibold">For International Customers</h3>
                  <p className="text-sm opacity-90 mt-1">
                ...
                <div className="p-6">
                  <div className="bg-blue-50 p-4 rounded-lg mb-6 border border-blue-100">
                    <p className="text-blue-800 font-medium">
                      One-time payment of $30 USD via PayPal
                    </p>
                    <p className="text-sm text-blue-600 mt-1">
                  ...
                  <div className="mb-2">
                    ...
                    <a href="https://www.paypal.com/paypalme/synergybrandarch/30" target="_blank" rel="noopener noreferrer" className="block w-full mt-4">
                      <button className="w-full bg-[#0070BA] hover:bg-[#003087] text-white font-medium py-4 px-4 rounded-lg transition-all flex items-center justify-center">
                  ...
                  <div className="mt-4 space-y-2">
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                      <CheckCircle2 className="text-green-500 h-4 w-4 flex-shrink-0" />
                      <span>Secure international transactions</span>
                    </div>
                  </div>
                </div>
              </div>
